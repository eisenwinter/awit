...
brief: >-
  Implement the output layer every list-shaped command renders through: format detection, the one-line compact form, the tabwriter table, and indented JSON, all pinned by golden files with an -update flag.
status: closed
deps: []
labels: [phase1, p1]
refs_base: repo
