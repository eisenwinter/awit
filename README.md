...
Use `awit skill sync` afterwards to refresh those copies (overwrites hand edits).
...
| `awit skill sync`               | -                                                                                                                                                                                                                                                                           | Refresh every detected skill target, overwriting hand edits; print `current`/`updated`/`created` plus the repo-relative slash path; inherit `--repo`; exit 0 including zero targets; first I/O error stops with no success line for the failed dest; no dry-run or JSON                                                                                                                                |
